...
namespace StereoKit.Framework
{
    public class PassthroughFBExt : IStepper
    {
        ...
        void StartPassthrough()
        {
            ...
            XrPassthroughCreateInfoFB passthroughInfo = new XrPassthroughCreateInfoFB(XrPassthroughFlagsFB.IS_RUNNING_AT_CREATION_BIT_FB);
            XrResult result = xrCreatePassthroughFB(
                Backend.OpenXR.Session,
                ref passthroughInfo,
                out activePassthrough);

            XrPassthroughLayerCreateInfoFB layerInfo = new XrPassthroughLayerCreateInfoFB(activePassthrough, XrPassthroughFlagsFB.IS_RUNNING_AT_CREATION_BIT_FB, XrPassthroughLayerPurposeFB.RECONSTRUCTION_FB);
...
#pragma warning restore 0169
        ...
        delegate XrResult del_xrCreatePassthroughFB(ulong session, ref XrPassthroughCreateInfoFB createInfo, out XrPassthroughFB outPassthrough);
        ...
        delegate XrResult del_xrCreatePassthroughLayerFB(ulong session, ref XrPassthroughLayerCreateInfoFB createInfo, out XrPassthroughLayerFB outLayer);
        ...
        delegate XrResult del_xrPassthroughLayerSetStyleFB(XrPassthroughLayerFB layer, ref XrPassthroughStyleFB style);
